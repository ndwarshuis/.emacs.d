...
#+END_SRC
**** sql functions
These are =org-mode=-agnostic functions that pertain to sql.
#+BEGIN_SRC emacs-lisp
(require 'sql)
...
#+END_SRC
**** org sql extractors
Extractors run through the parsed org tree and extract the useful information to insert into the database.
#+BEGIN_SRC emacs-lisp
